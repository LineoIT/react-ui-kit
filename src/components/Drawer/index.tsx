...
export function Drawer({ open, position = 'left', overlay = false, children }: React.PropsWithChildren<{ open: boolean; position?: 'left' | 'right'; overlay?: boolean }>) {
    ...
    return (
        <>
            ...
            <div
                className={`top-0  absolute h-full z-40  shadow-2xl ease-in-out duration-300  ${_subClass}
