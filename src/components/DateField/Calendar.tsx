...
export const IconChevron = (prop: React.SVGProps<SVGSVGElement>) => {
    return <svg  {...prop} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
const Button = ({ children, className, ...props }: React.ButtonHTMLAttributes<HTMLButtonElement>) => {
    return <button {...props} className={"rounded-full outline-none bg-black/10 dark:bg-white/10 active:bg-black/20 active:dark:bg-white/20 " + className} >
        {children}
    </button>
}
