...
import { useAlertAccentTheming, useAlertTheming, Variant } from "./helper";
...
const Alert: React.FC<React.PropsWithChildren<{
  variant?: Variant;
  header?: string;
  content?: string;
  closable?: boolean;
  ...
  const accentTheming = useAlertAccentTheming(prop.variant);
