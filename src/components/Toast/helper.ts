...
export function addItemHTML(content: string, id: any, variant: Variant, closable?: boolean) {
...
export const getTheming = (variant: Variant) => {
    switch (variant) {
        case 'error':
...
export const getAccentTheming = (variant: Variant) => {
    switch (variant) {
        case 'error':
