...
const TextField = (_a) => {
    ...
    return (React.createElement("div", { className: `${rounded} border dark:border-gray-500 focus-within:ring-1 bg-white dark:bg-black dark:text-gray-300 dark:bg-opacity-30 dark:focus-within:bg-opacity-10 dark:focus-within:text-gray-200 dark:placeholder-gray-400  ${color}` },
