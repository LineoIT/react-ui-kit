...
exports.getAccentTheming = exports.getTheming = exports.addItemHTML = void 0;
function addItemHTML(content, id, variant, closable) {
    const accentTheming = (0, exports.getAccentTheming)(variant);
    return /* html */ `
        ...
        : ''}
              ...
              <p class="font-medium flex-1">${content}</p>
              ${closable
        ? /* html */ `<div class="ml-3">
                    <button
...
exports.addItemHTML = addItemHTML;
const getTheming = (variant) => {
    switch (variant) {
        case 'error':
...
exports.getTheming = getTheming;
const getAccentTheming = (variant) => {
    switch (variant) {
        case 'error':
...
exports.getAccentTheming = getAccentTheming;
