...
const SelectField = ({ placeholder = '', items = [], error = false, searchPlaceholder = 'search item', onChange, value }) => {
    ...
    return (react_1.default.createElement("div", { className: "relative min-w-[180px] font-medium" },
        ...
        react_1.default.createElement("ul", { className: `absolute z-10 text-gray-500 max-h-[600px] bg-white dark:bg-slate-800 dark:text-gray-300 shadow drop-shadow-2xl  rounded  mt-1 overflow-y-auto transition-all duration-200   ${
