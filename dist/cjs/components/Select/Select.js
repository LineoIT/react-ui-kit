...
const Select = (_a) => {
    ...
    return (React.createElement("div", { className: ` rounded px-2 border dark:border-gray-500 focus-within:ring-1 dark:text-gray-300  dark:focus-within:bg-white/10 dark:focus-within:text-gray-200   ${color}` },
