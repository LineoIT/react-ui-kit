...
function Drawer({ open, position = 'left', overlay = false, children }) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement("div", { className: `top-0  absolute h-full z-40  shadow-2xl ease-in-out duration-300  ${_subClass}
